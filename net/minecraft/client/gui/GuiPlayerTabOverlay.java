...
public class GuiPlayerTabOverlay extends Gui
{
    ...
    public void func_175249_a(int p_175249_1_, Scoreboard p_175249_2_, ScoreObjective p_175249_3_)
    {
        ...
        if (var17 != null)
        {
            ...
            for (var19 = var17.iterator(); var19.hasNext(); var15 += this.field_175250_f.fontRendererObj.FONT_HEIGHT)
            {
                ...
                this.field_175250_f.fontRendererObj.drawStringWithDropShadow(var20, (float)(p_175249_1_ / 2 - var21 / 2), (float)var15, -1);
            }
        ...
        for (int var30 = 0; var30 < var28; ++var30)
        {
            ...
            if (var30 < var5.size())
            {
                ...
                if (var24.getGameType() == WorldSettings.GameType.SPECTATOR)
                {
                    ...
                    this.field_175250_f.fontRendererObj.drawStringWithDropShadow(var25, (float)var22, (float)var23, -1862270977);
                }
                else
                {
                    this.field_175250_f.fontRendererObj.drawStringWithDropShadow(var25, (float)var22, (float)var23, -1);
                }
    ...
    private void func_175247_a(ScoreObjective p_175247_1_, int p_175247_2_, String p_175247_3_, int p_175247_4_, int p_175247_5_, NetworkPlayerInfo p_175247_6_)
    {
        ...
        if (p_175247_1_.func_178766_e() == IScoreObjectiveCriteria.EnumRenderType.HEARTS)
        {
            ...
            if (var8 > 0)
            {
                ...
                else
                {
                    ...
                    this.field_175250_f.fontRendererObj.drawStringWithDropShadow(var14, (float)((p_175247_5_ + p_175247_4_) / 2 - this.field_175250_f.fontRendererObj.getStringWidth(var14) / 2), (float)p_175247_2_, var13);
                }
            }
        }
        else
        {
            ...
            this.field_175250_f.fontRendererObj.drawStringWithDropShadow(var15, (float)(p_175247_5_ - this.field_175250_f.fontRendererObj.getStringWidth(var15)), (float)p_175247_2_, 16777215);
        }
    }
