    ...
    public void drawTextBox()
    {
        if (this.getVisible())
        {
            ...
            if (var4.length() > 0)
            {
                ...
                var9 = this.fontRendererInstance.drawStringWithDropShadow(var10, (float)var7, (float)var8, var1);
            }
            ...
            {
                var9 = this.fontRendererInstance.drawStringWithDropShadow(var4.substring(var2), (float)var9, (float)var8, var1);
            }
            ...
            if (var6)
            {
                ...
                {
                    this.fontRendererInstance.drawStringWithDropShadow("_", (float)var11, (float)var8, var1);
                }
            }
