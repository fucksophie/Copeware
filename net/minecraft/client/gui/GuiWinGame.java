    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        for (var11 = 0; var11 < this.field_146582_i.size(); ++var11)
        {
            ...
            if ((float)var10 + var9 + 12.0F + 8.0F > 0.0F && (float)var10 + var9 < (float)this.height)
            {
                ...
                {
                    this.fontRendererObj.drawStringWithDropShadow(var13.substring(3), (float)(var7 + (var6 - this.fontRendererObj.getStringWidth(var13.substring(3))) / 2), (float)var10, 16777215);
                }
                else
                {
                    this.fontRendererObj.fontRandom.setSeed((long)var11 * 4238972211L + (long)(this.field_146581_h / 4));
                    this.fontRendererObj.drawStringWithDropShadow(var13, (float)var7, (float)var10, 16777215);
                }
            }
