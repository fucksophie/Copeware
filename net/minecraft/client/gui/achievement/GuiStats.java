            ...
            if (p_148142_2_ >= this.top && p_148142_2_ <= this.bottom)
            {
                ...
                else
                {
                    ...
                    if (var9.length() > 0)
                    {
                        ...
                        GuiStats.this.fontRendererObj.drawStringWithDropShadow(var9, (float)var6, (float)var7, -1);
                    }
                }
            }
        }
        ...
        protected void func_148213_a(StatCrafting p_148213_1_, int p_148213_2_, int p_148213_3_)
        {
            if (p_148213_1_ != null)
            {
                ...
                if (var7.length() > 0)
                {
                    ...
                    GuiStats.this.fontRendererObj.drawStringWithDropShadow(var7, (float)var8, (float)var9, -1);
                }
            }
        }
