    ...
    protected void drawAchievementScreen(int p_146552_1_, int p_146552_2_, float p_146552_3_)
    {
        ...
        if (var33 != null)
        {
            ...
            if (this.statFileWriter.canUnlockAchievement(var33))
            {
                ...
                if (this.statFileWriter.hasAchievementUnlocked(var33))
                {
                    this.fontRendererObj.drawStringWithDropShadow(I18n.format("achievement.taken", new Object[0]), (float)var40, (float)(var41 + var31 + 4), -7302913);
                }
            }
            else
            {
            ...
            if (var36 != null)
            {
                this.fontRendererObj.drawStringWithDropShadow(var36, (float)var40, (float)var41, this.statFileWriter.canUnlockAchievement(var33) ? (var33.getSpecial() ? -128 : -1) : (var33.getSpecial() ? -8355776 : -8355712));
            }
        }
