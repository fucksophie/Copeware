...
public class Gui
{
    ...
    {
        fontRendererIn.drawStringWithDropShadow(text, (float)(f - fontRendererIn.getStringWidth(text) / 2), (float)g, color);
    }
    ...
    {
        fontRendererIn.drawStringWithDropShadow(text, (float)x, (float)y, color);
    }
