...
public class GuiIngame extends Gui
{
    ...
    public void func_175182_a(ScaledResolution p_175182_1_)
    {
        ...
        if (this.remainingHighlightTicks > 0 && this.highlightingItemStack != null)
        {
            ...
            if (var5 > 0)
            {
                ...
                GlStateManager.enableBlend();
                GlStateManager.tryBlendFuncSeparate(770, 771, 1, 0);
                this.func_175179_f().drawStringWithDropShadow(var2, (float)var3, (float)var4, 16777215 + (var5 << 24));
                GlStateManager.disableBlend();
                GlStateManager.popMatrix();
            }
        }
    ...
    public void func_175185_b(ScaledResolution p_175185_1_)
    {
        ...
        this.func_175179_f().drawStringWithDropShadow(var2, (float)(p_175185_1_.getScaledWidth() - var3 - 10), 5.0F, 16777215);
        this.mc.mcProfiler.endSection();
    }
    ...
    private void renderBossHealth()
    {
        if (BossStatus.bossName != null && BossStatus.statusBarTime > 0)
        {
            ...
            this.func_175179_f().drawStringWithDropShadow(var8, (float)(var3 / 2 - this.func_175179_f().getStringWidth(var8) / 2), (float)(var7 - 10), bossTextColor);
            GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
            this.mc.getTextureManager().bindTexture(icons);
        }
    }
