    ...
    private void drawActivePotionEffects()
    {
        ...
        if (!var4.isEmpty())
        {
            ...
            for (Iterator var6 = this.mc.thePlayer.getActivePotionEffects().iterator(); var6.hasNext(); var2 += var5)
            {
                ...
                this.fontRendererObj.drawStringWithDropShadow(var11, (float)(var1 + 10 + 18), (float)(var2 + 6), 16777215);
                String var10 = Potion.getDurationString(var7);
                this.fontRendererObj.drawStringWithDropShadow(var10, (float)(var1 + 10 + 18), (float)(var2 + 6 + 10), 8355711);
            }
        }
    }
}
