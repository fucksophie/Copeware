...
public abstract class Render
{
    ...
    protected void renderLivingLabel(Entity p_147906_1_, String p_147906_2_, double p_147906_3_, double p_147906_5_, double p_147906_7_, int p_147906_9_)
    {
        ...
        if (var10 <= (double)(p_147906_9_ * p_147906_9_))
        {
            ...
            float var13 = 1.6F;
            boolean nameTagsActive = Client.getModuleByName("Nametags").toggled;

            float var14 = 0.016666668F * var13 * (p_147906_1_.getDistanceToEntity(this.renderManager.livingPlayer) > 10 && nameTagsActive ? p_147906_1_.getDistanceToEntity(this.renderManager.livingPlayer) / 10 : 1);
            var14 *= (nameTagsActive ? (p_147906_1_.boundingBox.getAverageEdgeLength() > -50 ? 1 : p_147906_1_.getDistanceToEntity(this.renderManager.livingPlayer) / 300) : 1);
