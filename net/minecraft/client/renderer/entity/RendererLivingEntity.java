...
public abstract class RendererLivingEntity extends Render
{
    ...
    protected void renderModel(EntityLivingBase p_77036_1_, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
        ...
        if (var8 || var9)
        {
            ...
            if(Client.getModuleByName("Esp").isEnabled()){
            		if((p_77036_1_ instanceof EntityPlayer && ((BooleanSetting)Client.getModuleByName("Esp").getSetting("players")).isEnabled()) ||
            			(p_77036_1_ instanceof EntityAnimal && ((BooleanSetting)Client.getModuleByName("Esp").getSetting("animals")).isEnabled()) ||
            			(p_77036_1_ instanceof EntityCreature && ((BooleanSetting)Client.getModuleByName("Esp").getSetting("monsters")).isEnabled())){
            			GL11.glPushMatrix();
                        {
