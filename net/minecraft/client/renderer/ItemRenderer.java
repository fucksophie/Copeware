...
import lv.yourfriend.copeware.modules.render.Animations;
...
public class ItemRenderer
{
    ...
    public void renderItemInFirstPerson(float p_78440_1_)
    {
        ...
        GlStateManager.pushMatrix();
        NumberSetting itemSize = (NumberSetting)Client.getModuleByName("Animations").getSetting("itemsize");
        if (this.itemToRender != null)
        {
            ...
            else if (var3.getItemInUseCount() > 0)
            {
                ...
                switch (ItemRenderer.SwitchEnumAction.field_178094_a[var7.ordinal()])
                {
                    ...
                    case 4:
                        if (Animations.AnimationsState == 1) {
                            this.func_178096_b((float) ((NumberSetting)Client.getModuleByName("Animations").getSetting("SwordBlockY")).getValue(), var4);
                        } else {
                            this.func_178096_b(-0.2f, var4);
                        }
                        this.func_178103_d();
                        if (itemSize != null && Animations.AnimationsState == 1) {
                            GlStateManager.scale(itemSize.getValue(),itemSize.getValue(),itemSize.getValue());
                        } else {
            ...
            else
            {
                ...
                if (Animations.AnimationsState == 1) {
                    this.func_178096_b((float) ((NumberSetting)Client.getModuleByName("Animations").getSetting("ItemY")).getValue(), var4);
                } else {
                    this.func_178096_b(-0.2f, var4);
                }
