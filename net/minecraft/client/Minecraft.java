...
import lv.yourfriend.copeware.ui.MainMenu;
...
public class Minecraft implements IThreadListener, IPlayerUsage
{
    ...
    private void func_175609_am() throws LWJGLException
    {
        ...
        Display.setTitle("Loading " + Client.name + " " + Client.version);
    ...
    private void displayDebugInfo(long elapsedTicksTime)
    {
        if (this.mcProfiler.profilingEnabled)
        {
            ...
            var14 = 16777215;
            this.fontRendererObj.drawStringWithDropShadow(var20, (float)(var8 - var7), (float)(var9 - var7 / 2 - 16), var14);
            this.fontRendererObj.drawStringWithDropShadow(var20 = var19.format(var4.field_76330_b) + "%", (float)(var8 + var7 - this.fontRendererObj.getStringWidth(var20)), (float)(var9 - var7 / 2 - 16), var14);
            ...
            for (int var21 = 0; var21 < var3.size(); ++var21)
            {
                ...
                this.fontRendererObj.drawStringWithDropShadow(var23, (float)(var8 - var7), (float)(var9 + var7 / 2 + var21 * 8 + 20), var22.func_76329_a());
                this.fontRendererObj.drawStringWithDropShadow(var23 = var19.format(var22.field_76332_a) + "%", (float)(var8 + var7 - 50 - this.fontRendererObj.getStringWidth(var23)), (float)(var9 + var7 / 2 + var21 * 8 + 20), var22.func_76329_a());
                this.fontRendererObj.drawStringWithDropShadow(var23 = var19.format(var22.field_76330_b) + "%", (float)(var8 + var7 - this.fontRendererObj.getStringWidth(var23)), (float)(var9 + var7 / 2 + var21 * 8 + 20), var22.func_76329_a());
            }
        }
    }
