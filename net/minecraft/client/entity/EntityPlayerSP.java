...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    {
    	EventUpdate eventu = new EventUpdate();
    	eventu.setType(EventType.PRE);
    	Client.onEvent(eventu);
    	
    	EventMotion eventm = new EventMotion(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
    	eventm.setType(EventType.PRE);
    	Client.onEvent(eventm);
        ...
        {
            double var3 = eventm.getX() - this.field_175172_bI;
            double var5 = eventm.getY() - this.field_175166_bJ;
            double var7 = eventm.getZ() - this.field_175167_bK;
            double var9 = (double)(eventm.getYaw() - this.field_175164_bL);
            double var11 = (double)(eventm.getPitch() - this.field_175165_bM);
            ...
            if (this.ridingEntity == null)
            {
                if (var13 && var14)
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(eventm.getX(), eventm.getY(), eventm.getZ(), eventm.getYaw(), eventm.getPitch(), eventm.isOnGround()));
                }
                else if (var13)
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C04PacketPlayerPosition(eventm.getX(), eventm.getY(), eventm.getZ(), eventm.isOnGround()));
                }
                else if (var14)
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer.C05PacketPlayerLook(eventm.getYaw(), eventm.getPitch(), eventm.isOnGround()));
                }
                else
                {
                    this.sendQueue.addToSendQueue(new C03PacketPlayer(eventm.isOnGround()));
                }
            }
            else
            {
                this.sendQueue.addToSendQueue(new C03PacketPlayer.C06PacketPlayerPosLook(this.motionX, -999.0D, this.motionZ, eventm.getYaw(), eventm.getPitch(), eventm.isOnGround()));
                var13 = false;
            }
            ...
            if (var13)
            {
                this.field_175172_bI = eventm.getX();
                this.field_175166_bJ = eventm.getY();
                this.field_175167_bK = eventm.getZ();
                this.field_175168_bP = 0;
            }

            if (var14)
            {
                this.field_175164_bL = eventm.getYaw();
                this.field_175165_bM = eventm.getPitch();
            }
        }
    	EventMotion eventy = new EventMotion(this.posX, this.getEntityBoundingBox().minY, this.posZ, this.rotationYaw, this.rotationPitch, this.onGround);
    	eventy.setType(EventType.POST);
    	Client.onEvent(eventy);
    }
