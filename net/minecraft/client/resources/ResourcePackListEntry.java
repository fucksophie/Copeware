...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public void drawEntry(int slotIndex, int x, int y, int listWidth, int slotHeight, int mouseX, int mouseY, boolean isSelected)
    {
        ...
        this.field_148317_a.fontRendererObj.drawStringWithDropShadow(var13, (float)(x + 32 + 2), (float)(y + 1), 16777215);
        ...
        {
            this.field_148317_a.fontRendererObj.drawStringWithDropShadow((String)var11.get(var12), (float)(x + 32 + 2), (float)(y + 12 + 10 * var12), 8421504);
        }
    }
