...
public class MoveUtils {
    ...
    public static void setSpeedWithoutStrafe(double speed) {
        double forward = mc.thePlayer.movementInput.moveForward;
        double strafe = mc.thePlayer.movementInput.moveStrafe;
        float yaw = mc.thePlayer.rotationYaw;
        if ((forward == 0.0D) && (strafe == 0.0D)) {
            ...
            mc.thePlayer.motionX = speed * Math.cos(Math.toRadians(yaw + 90.0F)) + strafe  * Math.sin(Math.toRadians(yaw + 90.0F));
            mc.thePlayer.motionZ =  speed * Math.sin(Math.toRadians(yaw + 90.0F)) - strafe * Math.cos(Math.toRadians(yaw + 90.0F));
        }
    }
