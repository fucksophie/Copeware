        ...
        for (int index = 0; index < text.length(); index++) {
            ...
            if (character == '\u00a7') {
                ...
                if (colorIndex < 16) {
                    ...
                    if (italic) {
                        GL11.glBindTexture(GL11.GL_TEXTURE, this.texItalicBold.getGlTextureId());
                        currentData = this.boldItalicChars;
                    } else {
                        GL11.glBindTexture(GL11.GL_TEXTURE, this.texBold.getGlTextureId());
                    ...
                    if (bold) {
                        ...
                        GL11.glBindTexture(GL11.GL_TEXTURE, this.texItalic.getGlTextureId());
