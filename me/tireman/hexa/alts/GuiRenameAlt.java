...
extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) {
        switch (button.id) {
            ...
            case 0: {
            	String oldName = this.manager.selectedAlt.getUsername();
            	String oldPassword = this.manager.selectedAlt.getPassword();
            	this.nameField.setText(oldName);
            	this.pwField.setText(oldPassword);
                this.manager.selectedAlt.setMask(this.nameField.getText());
                this.manager.selectedAlt.setPassword(this.pwField.getText());
                this.status = "Edited!";
                System.out.println("Saving Edited " + this.nameField.getText() + " somewhere.");
            }
        }
    }
