    ...
    public void drawTextBox() {
        if (this.func_73778_q()) {
            ...
            if (var4.length() > 0) {
                ...
                var9 = Minecraft.getMinecraft().fontRendererObj.drawStringWithDropShadow(this.text.replaceAll("(?s).", "*"), var7, var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                Minecraft.getMinecraft().fontRendererObj.drawStringWithDropShadow(var4.substring(var2), var9, var8, var1);
            }
            if (var6) {
                if (var10) {
                    ...
                    Minecraft.getMinecraft().fontRendererObj.drawStringWithDropShadow("_", var11, var8, var1);
                }
            }
            if (var3 != var2) {
